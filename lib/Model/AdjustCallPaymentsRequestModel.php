...
class AdjustCallPaymentsRequestModel implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $inbound_call_id Call ID
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string $reason Reason for adjusting the call payments
     *
     * @return $this
     */
     ...
     *
     * @param bool $adjust_conversion Specifies whether the conversion amount should be adjusted
     *
     * @return $this
     */
     ...
     *
     * @param double $adjust_converion_by_amount Specifies the amount by which the call conversion should be adjusted (increased or descreased)
     *
     * @return $this
     */
     ...
     * Sets adjust_payout
     *
     * @param bool $adjust_payout Specifies whether the payout amount should be adjusted
     *
     * @return $this
     */
     ...
     *
     * @param double $adjust_payout_by_amount Specifies the amount by which the call payout should be adjusted (increased or descreased)
     *
     * @return $this
     */
