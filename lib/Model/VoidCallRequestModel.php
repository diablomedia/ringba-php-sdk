...
class VoidCallRequestModel implements ModelInterface, ArrayAccess
{
     ...
     * Sets void_reason
     *
     * @param string $void_reason Reason for voiding the call payments
     *
     * @return $this
     */
     ...
     *
     * @param bool $void_conversion Specifies whether the conversion should be voided.
     *
     * @return $this
     */
     ...
     *
     * @param double $void_converion_amount Speficies the amount to deduct from the conversion amount. Value cannot be less than 0.
     *
     * @return $this
     */
     ...
     * Sets void_payout
     *
     * @param bool $void_payout Specifies whether the payout should be voided.
     *
     * @return $this
     */
     ...
     *
     * @param double $void_payout_amount Speficies the amount to deduct from the payout amount.
     *
     * @return $this
     */
