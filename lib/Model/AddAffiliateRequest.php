...
/**
 * AddAffiliateRequest Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddAffiliateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddAffiliateRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['affiliate_id'] === null) {
            $invalidProperties[] = "'affiliate_id' can't be null";
        }
