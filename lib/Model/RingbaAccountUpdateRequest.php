...
/**
 * RingbaAccountUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RingbaAccountUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RingbaAccountUpdateRequest';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'time_zone_id' => 'string',
        'account_address' => '\Ringba\Model\AddressRequestModel'
    ];
     ...
     *
     * @param \Ringba\Model\AddressRequestModel $account_address account_address
     *
     * @return $this
     */
