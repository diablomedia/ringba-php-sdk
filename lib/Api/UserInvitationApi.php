...
class UserInvitationApi
{
     ...
     * @return object
     */
    public function userInvitationUserListInvitations($accountid)
    {
        list($response) = $this->userInvitationUserListInvitationsWithHttpInfo($accountid);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function userInvitationUserListInvitationsWithHttpInfo($accountid)
    {
        $returnType = 'object';
        $request = $this->userInvitationUserListInvitationsRequest($accountid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userInvitationUserListInvitationsAsync($accountid)
    {
        return $this->userInvitationUserListInvitationsAsyncWithHttpInfo($accountid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userInvitationUserListInvitationsAsyncWithHttpInfo($accountid)
    {
        $returnType = 'object';
        $request = $this->userInvitationUserListInvitationsRequest($accountid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userInvitationUserListInvitationsRequest($accountid)
    {
        // verify the required parameter 'accountid' is set
        if ($accountid === null || (is_array($accountid) && count($accountid) === 0)) {
            throw new \InvalidArgumentException(
