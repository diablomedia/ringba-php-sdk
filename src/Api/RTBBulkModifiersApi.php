...
class RTBBulkModifiersApi
{
    ...
    /**
     * Operation createRTBBulkAdjustmentfromCSV
     *
    ...
    /**
     * Operation createRTBBulkAdjustmentfromCSVWithHttpInfo
     *
     * Create RTB Bulk Adjustment from CSV
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
    ...
    public function createRTBBulkAdjustmentfromCSVWithHttpInfo($name, $authorization, $accountId, $file)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ringba\Model\CreateRTBBulkAdjustmentfromCSV' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ringba\Model\CreateRTBBulkAdjustmentfromCSV' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ringba\Model\CreateRTBBulkAdjustmentfromCSV', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ringba\Model\CreateRTBBulkAdjustmentfromCSV',
    ...
    /**
     * Operation createRTBBulkAdjustmentfromCSVAsync
     *
     * Create RTB Bulk Adjustment from CSV
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
    ...
    /**
     * Operation createRTBBulkAdjustmentfromCSVAsyncWithHttpInfo
     *
     * Create RTB Bulk Adjustment from CSV
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
    ...
    public function createRTBBulkAdjustmentfromCSVRequest($name, $authorization, $accountId, $file)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling createRTBBulkAdjustmentfromCSV'
            );
        }
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling createRTBBulkAdjustmentfromCSV'
            );
        }
