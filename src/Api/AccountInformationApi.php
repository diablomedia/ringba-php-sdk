...
class AccountInformationApi
{
    ...
    /**
     * Operation getAccountInfousingAPIToken
     *
    ...
    /**
     * Operation getAccountInfousingAPITokenWithHttpInfo
     *
     * Get Account Info using API Token
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
    ...
    public function getAccountInfousingAPITokenWithHttpInfo($authorization = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ringba\Model\GetAccountInfo' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ringba\Model\GetAccountInfo' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ringba\Model\GetAccountInfo', []),
    ...
    /**
     * Operation getAccountInfousingAPITokenAsync
     *
     * Get Account Info using API Token
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
    ...
    /**
     * Operation getAccountInfousingAPITokenAsyncWithHttpInfo
     *
     * Get Account Info using API Token
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
    ...
    /**
     * Create request for operation 'getAccountInfousingAPIToken'
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     * URL: https://api.ringba.com/v2/
     *
