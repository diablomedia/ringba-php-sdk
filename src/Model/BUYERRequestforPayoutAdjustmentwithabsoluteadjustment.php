...
/**
 * BUYERRequestforPayoutAdjustmentwithabsoluteadjustment Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class BUYERRequestforPayoutAdjustmentwithabsoluteadjustment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BUYERRequestforPayoutAdjustmentwithabsoluteadjustment';
     ...
     * Sets result
     *
     * @param \Ringba\Model\Result6 $result result
     *
     * @return self
     */
