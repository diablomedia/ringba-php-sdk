...
/**
 * GetAPITokenswithusage Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class GetAPITokenswithusage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAPITokenswithusage';
    ...
    protected static $openAPITypes = [
        ...
        'apiTokens' => '\Ringba\Model\ApiToken[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['apiTokens'] = $data['apiTokens'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apiTokens'] === null) {
            $invalidProperties[] = "'apiTokens' can't be null";
        }
     ...
     * Sets apiTokens
     *
     * @param \Ringba\Model\ApiToken[] $apiTokens 
     *
     * @return self
     */
