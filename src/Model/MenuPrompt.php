 ...
 */
class MenuPrompt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPrompt';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['say'] === null) {
            $invalidProperties[] = "'say' can't be null";
        }
     ...
     * Sets say
     *
     * @param \Ringba\Model\Say $say say
     *
     * @return self
     */
