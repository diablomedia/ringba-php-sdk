 ...
 */
class Report3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Report3';
    ...
    protected static $setters = [
        'partialResult' => 'setPartialResult',
        'records' => 'setRecords',
    ...
    {
        $this->container['partialResult'] = $data['partialResult'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['partialResult'] === null) {
            $invalidProperties[] = "'partialResult' can't be null";
        }
    ...
    {
        return $this->container['partialResult'];
    }

    /**
     * Sets partialResult
     *
     * @param bool $partialResult partialResult
     *
     * @return self
     */
    public function setPartialResult($partialResult)
    {
        $this->container['partialResult'] = $partialResult;
     ...
     * Sets records
     *
     * @param \Ringba\Model\Record3[] $records 
     *
     * @return self
     */
