...
/**
 * CheckDuplicateTargetsRequest Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class CheckDuplicateTargetsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckDuplicateTargetsRequest';
    ...
    protected static $openAPITypes = [
        ...
        'searchNumer' => 'string',
        'capsMigrated' => 'bool',
        'owner' => '\Ringba\Model\Owner20',
        'conversionTimerOffset' => 'int',
        'schedule' => '\Ringba\Model\Schedule30',
    ...
    protected static $attributeMap = [
        ...
        'highRateCost' => 'highRateCost',
        'ringbaNumberId' => 'ringbaNumberId',
        'targetCallIncrement' => 'targetCallIncrement',
        'searchNumer' => '_SearchNumer',
        'capsMigrated' => 'capsMigrated',
        'owner' => 'owner',
    ...
    protected static $setters = [
        ...
        'highRateCost' => 'setHighRateCost',
        'ringbaNumberId' => 'setRingbaNumberId',
        'targetCallIncrement' => 'setTargetCallIncrement',
        'searchNumer' => 'setSearchNumer',
        'capsMigrated' => 'setCapsMigrated',
        'owner' => 'setOwner',
    ...
    protected static $getters = [
        ...
        'highRateCost' => 'getHighRateCost',
        'ringbaNumberId' => 'getRingbaNumberId',
        'targetCallIncrement' => 'getTargetCallIncrement',
        'searchNumer' => 'getSearchNumer',
        'capsMigrated' => 'getCapsMigrated',
        'owner' => 'getOwner',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['highRateCost'] = $data['highRateCost'] ?? null;
        $this->container['ringbaNumberId'] = $data['ringbaNumberId'] ?? null;
        $this->container['targetCallIncrement'] = $data['targetCallIncrement'] ?? null;
        $this->container['searchNumer'] = $data['searchNumer'] ?? null;
        $this->container['capsMigrated'] = $data['capsMigrated'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['highRateCost'] === null) {
            $invalidProperties[] = "'highRateCost' can't be null";
        }
        if ($this->container['ringbaNumberId'] === null) {
            $invalidProperties[] = "'ringbaNumberId' can't be null";
        }
        if ($this->container['targetCallIncrement'] === null) {
            $invalidProperties[] = "'targetCallIncrement' can't be null";
        }
        if ($this->container['searchNumer'] === null) {
            $invalidProperties[] = "'searchNumer' can't be null";
        }
        if ($this->container['capsMigrated'] === null) {
            $invalidProperties[] = "'capsMigrated' can't be null";
        }
     ...
     * @return float
     */
    public function getHighRateCost()
    {
        return $this->container['highRateCost'];
    }

    /**
     * Sets highRateCost
     *
     * @param float $highRateCost highRateCost
     *
     * @return self
     */
    public function setHighRateCost($highRateCost)
    {
        $this->container['highRateCost'] = $highRateCost;
     ...
     * @return string
     */
    public function getRingbaNumberId()
    {
        return $this->container['ringbaNumberId'];
    }

    /**
     * Sets ringbaNumberId
     *
     * @param string $ringbaNumberId ringbaNumberId
     *
     * @return self
     */
    public function setRingbaNumberId($ringbaNumberId)
    {
        $this->container['ringbaNumberId'] = $ringbaNumberId;
     ...
     * @return string
     */
    public function getSearchNumer()
    {
        return $this->container['searchNumer'];
    }

    /**
     * Sets searchNumer
     *
     * @param string $searchNumer searchNumer
     *
     * @return self
     */
    public function setSearchNumer($searchNumer)
    {
        $this->container['searchNumer'] = $searchNumer;
     ...
     * @return bool
     */
    public function getCapsMigrated()
    {
        return $this->container['capsMigrated'];
    }

    /**
     * Sets capsMigrated
     *
     * @param bool $capsMigrated capsMigrated
     *
     * @return self
     */
    public function setCapsMigrated($capsMigrated)
    {
        $this->container['capsMigrated'] = $capsMigrated;
     ...
     * Sets owner
     *
     * @param \Ringba\Model\Owner20 $owner owner
     *
     * @return self
     */
     ...
     * Gets schedule
     *
     * @return \Ringba\Model\Schedule30
     */
     ...
     * Sets schedule
     *
     * @param \Ringba\Model\Schedule30 $schedule schedule
     *
     * @return self
     */
