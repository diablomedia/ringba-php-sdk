...
/**
 * CallIVRTree6 Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class CallIVRTree6 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CallIVRTree6';
    ...
    protected static $openAPITypes = [
        'root' => '\Ringba\Model\Root',
        'isFinalized' => 'bool',
        'nodes' => '\Ringba\Model\Nodes6',
        'id' => 'string',
        'name' => 'string',
        'accountId' => 'string',
        'enabled' => 'bool',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['isFinalized'] = $data['isFinalized'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['isFinalized'] === null) {
            $invalidProperties[] = "'isFinalized' can't be null";
        }
     ...
     * Sets root
     *
     * @param \Ringba\Model\Root $root root
     *
     * @return self
     */
     ...
     * Sets isFinalized
     *
     * @param bool $isFinalized isFinalized
     *
     * @return self
     */
     ...
     * Sets nodes
     *
     * @param \Ringba\Model\Nodes6 $nodes nodes
     *
     * @return self
     */
