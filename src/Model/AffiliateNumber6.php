...
/**
 * AffiliateNumber6 Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class AffiliateNumber6 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AffiliateNumber6';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['localNumber'] === null) {
            $invalidProperties[] = "'localNumber' can't be null";
        }
     ...
     * Sets localNumber
     *
     * @param string $localNumber localNumber
     *
     * @return self
     */
