...
/**
 * TA2f6961e921ef4b92b7304dd76db8336f2 Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class TA2f6961e921ef4b92b7304dd76db8336f2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TA2f6961e921ef4b92b7304dd76db8336f2';
    ...
    protected static $openAPIFormats = [
        'totalSum' => 'int32',
        'currentMonthSum' => 'int32',
        'currentHourSum' => 'int32',
        'currentDaySum' => 'int32',
        'total' => 'int32',
        'currentMonth' => 'int32',
        'currentDay' => 'int32',
    ...
    protected static $setters = [
        ...
        'currentMonthSum' => 'setCurrentMonthSum',
        'currentHourSum' => 'setCurrentHourSum',
        'currentDaySum' => 'setCurrentDaySum',
        'total' => 'setTotal',
    ...
    protected static $getters = [
        ...
        'currentMonthSum' => 'getCurrentMonthSum',
        'currentHourSum' => 'getCurrentHourSum',
        'currentDaySum' => 'getCurrentDaySum',
        'total' => 'getTotal',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['currentMonthSum'] = $data['currentMonthSum'] ?? null;
        $this->container['currentHourSum'] = $data['currentHourSum'] ?? null;
        $this->container['currentDaySum'] = $data['currentDaySum'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['currentMonthSum'] === null) {
            $invalidProperties[] = "'currentMonthSum' can't be null";
        }
        if ($this->container['currentHourSum'] === null) {
            $invalidProperties[] = "'currentHourSum' can't be null";
        }
        if ($this->container['currentDaySum'] === null) {
            $invalidProperties[] = "'currentDaySum' can't be null";
        }
    ...
    /**
     * Gets currentMonthSum
     *
     * @return int
     */
    public function getCurrentMonthSum()
    {
        return $this->container['currentMonthSum'];
    }

    /**
     * Sets currentMonthSum
     *
     * @param int $currentMonthSum currentMonthSum
     *
     * @return self
     */
    public function setCurrentMonthSum($currentMonthSum)
    {
        $this->container['currentMonthSum'] = $currentMonthSum;
     ...
     * @return int
     */
    public function getCurrentHourSum()
    {
        return $this->container['currentHourSum'];
    }

    /**
     * Sets currentHourSum
     *
     * @param int $currentHourSum currentHourSum
     *
     * @return self
     */
    public function setCurrentHourSum($currentHourSum)
    {
        $this->container['currentHourSum'] = $currentHourSum;
     ...
     * @return int
     */
    public function getCurrentDaySum()
    {
        return $this->container['currentDaySum'];
    }

    /**
     * Sets currentDaySum
     *
     * @param int $currentDaySum currentDaySum
     *
     * @return self
     */
    public function setCurrentDaySum($currentDaySum)
    {
        $this->container['currentDaySum'] = $currentDaySum;
