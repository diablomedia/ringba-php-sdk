...
/**
 * Number3TagsInner Class Doc Comment
 *
 * @category Class
 * @package  Ringba
 * @author   OpenAPI Generator team
 ...
 */
class Number3TagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Number3_tags_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tagValue'] === null) {
            $invalidProperties[] = "'tagValue' can't be null";
        }
        if ($this->container['tagName'] === null) {
            $invalidProperties[] = "'tagName' can't be null";
        }
        if ($this->container['tagSource'] === null) {
            $invalidProperties[] = "'tagSource' can't be null";
        }
     ...
     * Sets tagValue
     *
     * @param string $tagValue tagValue
     *
     * @return self
     */
     ...
     * Sets tagSource
     *
     * @param string $tagSource tagSource
     *
     * @return self
     */
