...
**affiliateNumbers** | [**\Ringba\Model\CampaignAffiliateNumbersInner[]**](CampaignAffiliateNumbersInner.md) |  |
**deDupeSettings** | [**\Ringba\Model\DeDupeSettings**](DeDupeSettings.md) |  |
**routes** | [**\Ringba\Model\Route[]**](Route.md) |  |
...
**enabled** | **bool** |  |
**version** | **int** |  |
**numberDisplayFormat** | **string** |  | [optional]
